...
num_users, num_movies = table.shape

# Data preprocessing
ratings_train = np.nan_to_num(table)
...
# Model definition
class Model:
    def __init__(self, parameters, feat = False, init_feat = 'random', k = 0):
...
Parameters = {'Dataset': ratings_train,
              'features': 60,
...
# Model Training
MyModel = Model(Parameters, feat = True)
